      ...
      <Container>
        <div class="container mx-auto px-5 py-12">
          <div class="mb-5 flex w-full flex-col text-center">
            <h1 class="title-font mb-4 text-2xl font-medium dark:text-white text-gray-900 sm:text-3xl">
              Advisory <span class="dark:text-white text-insp-300">Committee</span>
            </h1>
          </div>
            ...
            {members.map((member) => (
              <div class="w-full p-2 md:w-1/2 lg:w-1/3">
                <div class="flex h-full items-center rounded-lg border border-gray-200 p-4 shadow-md">
                  <div class="flex-grow">
                    <h2 class="title-font font-semibold text-gray-900 dark:text-white">
                      {member.name}
                    </h2>
